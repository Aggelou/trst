...
@RestController
@RequestMapping("/api/trst-kafka")
public class TrstKafkaResource {
    private final Logger log = LoggerFactory.getLogger(TrstKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaProducer<String, String> producer;
    private ExecutorService sseExecutorService = Executors.newCachedThreadPool();

    public TrstKafkaResource(KafkaProperties kafkaProperties) {
